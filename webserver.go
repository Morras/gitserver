...
func Setup(taskAPI http.Handler, config Config, userStore UserStore, ctxProvider ContextProvider) {
	...
	login := login{userStore: userStore, config: config, ctxProvider: ctxProvider}
